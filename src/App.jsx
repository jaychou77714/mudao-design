              ...
              <div>
                ...
                <div style={{ marginTop: 12, padding: "12px", background: "rgba(255,255,255,0.05)", borderRadius: 10 }}>
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
                    ...
                    <span style={{ fontSize: 13, color: "#f0a850" }}>－ $ {fmtMoney(Object.values(p.quote || {}).reduce((s, v) => s + num(v.cost), 0))}</span>
                  </div>
                  <div style={{ height: 1, background: "rgba(255,255,255,0.08)", margin: "8px 0" }} />
                  <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
                    <span style={{ fontSize: 12, color: "#555" }}>報價 - 成本利潤</span>
                    <span style={{ fontSize: 14, color: "#5b8af0", fontWeight: 600 }}>$ {fmtMoney(totalPrice - Object.values(p.quote || {}).reduce((s, v) => s + num(v.cost), 0))}</span>
                  </div>
                  {p.stage === "完工" && (
                    <>
                      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
