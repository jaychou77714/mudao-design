      ...
      <div className="glass-header" style={{ padding: "48px 20px 16px", position: "relative", zIndex: 10 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 4 }}>
          ...
          <div style={{ textAlign: "right" }}>
            <div style={{ fontSize: 16, fontWeight: 700, color: "#f0ead8" }}>
              {new Date().getFullYear()}
            </div>
            <div style={{ fontSize: 11, color: "#666" }}>
              {new Date().toLocaleDateString("zh-TW", { month: "long" })}
            </div>
          </div>
        </div>
      </div>
        ...
        {tab === "home" && (
          <div className="fade-up">
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 20 }}>
              ...
              <div onClick={() => setTab("垃圾場")} className="glass-stat" style={{ borderRadius: 14, padding: "14px 16px" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
                  <div style={{ fontSize: 26, fontWeight: 700, color: "#e05b5b" }}>{trashProjects.length}</div>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#e05b5b" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14H6L5 6"/><path d="M10 11v6M14 11v6"/><path d="M9 6V4h6v2"/></svg>
                </div>
                <div style={{ fontSize: 12, color: "#666" }}>垃圾場</div>
              </div>
            </div>
