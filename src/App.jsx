...
export default function App() {
  ...
  const allTabs = ["home", ...STAGES, "建材庫", "備忘錄"];
  ...
  return (
    <div style={{ minHeight: "100vh", background: "rgba(255,255,255,0.04)", color: "#e8e4dc", fontFamily: "'Noto Sans TC',sans-serif", maxWidth: 480, margin: "0 auto", display: "flex", flexDirection: "column", position: "relative" }}>
      ...
      <div className="glass-nav" style={{ display: "flex", overflowX: "auto", position: "relative", zIndex: 10 }}>
        {allTabs.map(t => {
          const label = t === "home" ? "總覽" : t === "備忘錄" ? "備忘" : t === "建材庫" ? "建材" : t;
          const color = t === "home" ? "#e8e4dc" : t === "備忘錄" ? "#c084f5" : t === "建材庫" ? "#50c8c8" : STAGE_COLORS[t];
          return (
        ...
        {tab === "home" && (
          <div className="fade-up">
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 20 }}>
              ...
              <div onClick={() => setTab("建材庫")} className="glass-stat" style={{ borderRadius: 14, padding: "16px" }}>
                <div style={{ fontSize: 24, fontWeight: 700, color: "#50c8c8", marginBottom: 4 }}>{materials.length}</div>
